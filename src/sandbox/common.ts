...
import { isBoundedFunction, isCallable, isConstructable, isOverWritable } from '../utils';
...
export function getTargetValue(target: any, value: any, p?: any): any {
   ...
   */
  if (isCallable(value) && isOverWritable(target, p) && !isBoundedFunction(value) && !isConstructable(value)) {
