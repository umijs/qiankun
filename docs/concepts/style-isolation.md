...
`styleIsolation` is a per-app field on the app configuration — set it wherever you describe the app, whether through [registerMicroApps](/api/register-micro-apps) or [loadMicroApp](/api/load-micro-app):
