...
The entry should declare only resources needed by this app and contain exactly one script marked as the entry. Use the official [bundler plugin](/ecosystem/bundler-plugin) to manage the marker instead of maintaining a script manifest by hand.
