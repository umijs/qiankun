...
It is not feasible to use the routing instance of micro-application directly to jump between micro-applications or micro-applications to main application page, such as the Link component of raact-router or router-link of vue, because the routing instance jump of micro-applications is based on the 'base' of routes. There are two ways to jump:
