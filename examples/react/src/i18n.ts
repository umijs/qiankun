 ...
 * channel and re-delivers it on `update` (see src/main.tsx) — a micro app is independent, so it
...
export const messages: Record<Locale, Messages> = {
  en: {
    ...
    stateNote: 'useState lives and dies with this app instance.',
    entry: 'entry',
    lifecycle: 'lifecycle',
  },
  zh: {
    ...
    localState: '本地状态',
    stateNote: 'useState 与这个应用实例同生共死。',
    entry: '入口',
    lifecycle: '生命周期',
  },
};
