...
describe(`invalid-bootstrap app`, () => {
  ...
  beforeEach(() => {
    ...
    return import('./invalid-bootstrap.app').then((app) => (myApp = app)).then((app) => app.reset());
  });
  ...
  it(`is never bootstrapped, mounted, or unmounted`, () => {
    return singleSpa.triggerAppChange().then(() => {
      ...
      expect(singleSpa.getAppStatus('./invalid-bootstrap.app')).toEqual('SKIP_BECAUSE_BROKEN');
