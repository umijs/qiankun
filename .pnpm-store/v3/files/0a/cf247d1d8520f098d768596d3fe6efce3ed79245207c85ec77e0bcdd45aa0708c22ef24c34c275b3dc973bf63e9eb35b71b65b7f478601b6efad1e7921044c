...
import { DomHandler, DomHandlerOptions, Node, Element, Document } from '@umijs/deps/types/cheerio/domhandler';
...
import * as ElementType from '@umijs/deps/types/cheerio/domelementtype';
export { ElementType };
